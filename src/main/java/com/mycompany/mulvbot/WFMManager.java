 ...
 * @author Samed OZKAN
 */
public class WFMManager extends ListenerAdapter {

    static public HashMap<String, String> Masters = new HashMap();
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (msg.getContentRaw().contains("!masterlist")) {
            ...
            try {
                ...
                Logger.getLogger(WFMManager.class.getName()).log(Level.SEVERE, null, ex);
            } finally {
                try {
                    file.close();
                } catch (IOException ex) {
